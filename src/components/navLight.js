...
import logoDark from '../assets/images/LogoM.png'
            ...
            <div className="container relative flex flex-wrap items-center justify-between">
                ...
                <div className={`navigation lg_992:order-1 lg_992:flex  ms-auto ${manu ? '' : 'hidden'}`} id="menu-collapse">
                    <ul className="navbar-nav nav-light sidebar-nav" id="navbar-navlist">
                        ...
                        <li className="nav-item">
                            <Link1 className="nav-link ms-0" to="about" smooth={true} duration={1000} activeClass='active' spy={true}>Founder</Link1>
                        </li>
                        <li className="nav-item">
                            <Link1 className="nav-link ms-0" to="services" smooth={true} duration={1000} activeClass='active' spy={true}>Overview</Link1>
                        </li>
                        <li className="nav-item">
                            <Link1 className="nav-link ms-0" to="review" smooth={true} duration={1000} activeClass='active' spy={true}>Q&A Session</Link1>
                        </li>
                        <li className="nav-item">
